...
Alamancos et al. [@Alamancos2014] provides a comprehensive overview of methods to study splicing from RNA-seq, which perform mapping, reconstruction of isoforms or splicing events, quantification and comparison. 

Hooper et al. [@Hooper2014] investigates the performance of DS methods.

Soneson et al. [@Soneson2016] compares different types of quantifications that can be used to conduct DS analyses.
